    ...
    function insertShortcode() {
        if (window.tinyMCE) {
            var shortcode_tag = '', 
				...
				portfolio_cat = jQuery('#portfolio_cat').val(), 
				...
				read_more_check = jQuery('#read_more_check');
            ...
            if (read_more_check.is(':checked')) {
                shortcode_tag += ' read_more="' + read_more_check.val() + '"';
            }
            ...
            <table class="describe">
                <tbody>
                    ...
                    <tr>
                        <th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
                            <span class="alignleft">
                                <label for="read_more_check"><?php _e('Read More', 'cmsmasters'); ?></label>
                            </span>
                        </th>
                        <td class="field" style="padding-top:15px;">
                            <input type="checkbox" value="true" name="read_more_check" id="read_more_check" class="popup_tr_value" />
                            <label for="read_more_check"><?php _e("Show posts 'Read More' button", 'cmsmasters'); ?></label>
                        </td>
                    </tr>
                </tbody>
            </table>
