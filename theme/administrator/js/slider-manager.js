 ...
 * @package WordPress
 * @subpackage Kindness
 * @since Kindness 1.3.1
 */

/**
 * Slider Manager v1.0.4 - jQuery Slider Manager
 * 
...
var sliderManager = {
        ...
        this.config = {
            ...
            _oResponsiveSlideFields : {
                ...
                'slide_as_link_target' : {
                    title : 'Open Slide Link In New Tab',
                    value : 'false',
                    type : 'checkbox',
                    category : 'slideaslink',
                    description : 'Some description'
    ...
    /**
     * hide next inputs after slide_add_video, slide_as_link_add and show_caption
     *
     * @return void
     * @access private
     */
