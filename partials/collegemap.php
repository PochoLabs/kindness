...
<link rel="stylesheet" href="http://www.thedream.us/wp-content/uploads/2015/12/reset.css">
<link rel="stylesheet" href="http://www.thedream.us/wp-content/uploads/2015/12/pure-css.css">
<!-- <link rel="stylesheet" href="http://www.thedream.us/wp-content/uploads/2015/12/style.css"> -->
<meta name="viewport" content="width=device-width, initial-scale=1">

<h1>TheDream.US National Scholarship Partner Colleges</h1>
<p class="description">
	<strong>Click the points to expand them.</strong>
</p>
<div class="distribution-map">
	<img src="http://www.thedream.us/wp-content/uploads/2016/01/160104-H1N1_USA_Map.png" class="map-image">
	...
	<div data-top="57.5" data-left="67" class="map-point">
		<div class="content">
			<div class="centered-y">
				<h2>Tennessee</h2>
				<p><a href="http://www.equalchanceforeducation.com/" target="_blank">Equal Chance for Education (ECE) </a></p>
			</div>
		</div>
	</div>
...
<p class="description">Italics: Two-Year Colleges
	<br>*Private University/College does not have in-state tuition
	<br>+For profit college owned by Kaplan, Inc. which is a wholly owned subsidiary of Graham Holdings Company.
	<br>CCG - Community College Graduates</p>
<div class="others">
	<div class="square-point">
		<div class="content">
			<div class="centered-y">
				<h2>Online Nationwide</h2>
				<p><a href="http://www.kaplanuniversity.edu/" target="_blank" class="for-profit">Kaplan University</a></p>
			</div>
		</div>
	</div>
	<div class="square-point">
		<div class="content">
			<div class="centered-y">
				<h2>Private Colleges Special Programs</h2>
				<p><a href="http://www.davidson.edu/" target="_blank">Davidson College</a></p>
				<p><a href="https://www.gettysburg.edu/" target="_blank">Gettysburg College</a></p>
				<p><a href="http://www.fandm.edu/" target="_blank">Franklin and Marshall</a></p>
			</div>
		</div>
	</div>
	<div class="square-point">
		<div class="content">
			<div class="centered-y">
				<h2>College Success Programs</h2>
				<p> <a href="https://collegetrack.org/" target="_blank">College Track</a></p>
				<p> <a href="http://www.collegematchla.org/index.html" target="_blank">College Match</a></p>
				<p> <a href="http://www.equalchanceforeducation.com/">ECE - Equal Chance for Education</a></p>
			</div>
		</div>
	</div>
</div>
...
<!-- <script src="http://www.thedream.us/wp-content/uploads/2015/12/index.js"></script> -->
